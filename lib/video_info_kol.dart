...
class VideoInfoKol extends StatefulWidget {
  const VideoInfoKol({Key? key}) : super(key: key);

  @override
  _VideoInfoKolState createState() => _VideoInfoKolState();
}

class _VideoInfoKolState extends State<VideoInfoKol> {
  List videoInfo = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/VideoInfoKol.json")
        .then((value) {
      setState(() {
