...
class VideoInfoKarin extends StatefulWidget {
  const VideoInfoKarin({Key? key}) : super(key: key);

  @override
  _VideoInfoKarinState createState() => _VideoInfoKarinState();
}

class _VideoInfoKarinState extends State<VideoInfoKarin> {
  List videoInfo = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/VideoInfoKarın.json")
        .then((value) {
      setState(() {
