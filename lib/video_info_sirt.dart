...
class VideoInfoSirt extends StatefulWidget {
  const VideoInfoSirt({Key? key}) : super(key: key);

  @override
  _VideoInfoSirtState createState() => _VideoInfoSirtState();
}

class _VideoInfoSirtState extends State<VideoInfoSirt> {
  List videoInfo = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/VideoInfoSırt.json")
        .then((value) {
      setState(() {
