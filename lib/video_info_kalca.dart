...
class VideoInfoKalca extends StatefulWidget {
  const VideoInfoKalca({Key? key}) : super(key: key);

  @override
  _VideoInfoKalcaState createState() => _VideoInfoKalcaState();
}

class _VideoInfoKalcaState extends State<VideoInfoKalca> {
  List videoInfo = [];
  ...
  _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/VideoInfoKalca.json")
        .then((value) {
      setState(() {
